...
public class Test_Steps {
	...
	@Given("^This is sample cucumber test feature$")
	public void sample_Cucumber_Test_Feature() {
		System.out.println("This is sample cucumber test feature.");
	}

	@Given("^User is  on google homepage$")
	public void user_is_on_google_homepage() {
		currentProjectPath = System.getProperty("user.dir");
		System.setProperty("webdriver.chrome.driver", currentProjectPath + "\\Jars\\chromedriver.exe");
	...
	public void search_string_is_validated_in_the_first_search_result() {
		Assert.assertTrue(
				" Assertion status for first search result containing " + SEARCH_STRING + " - " + " Actual HREF - "
						+ driver.findElement(By.xpath("//*[@id='rso']//a[contains(@href,'abcd')]")).getAttribute(HREF)
						+ " Expected search string - " + SEARCH_STRING,
				driver.findElement(By.xpath("//*[@id='rso']//a[contains(@href,'abcd')]")).getAttribute(HREF)
